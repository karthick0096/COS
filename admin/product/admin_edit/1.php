...
<body>
    <div class="row">
        <div class="col-md-1">
            ...
            <div class="main">
                <li><a href="http://localhost/admin_flow/product/admin_product/fetch1.php"><i class="fa fa-cube"></i></a></li>
                <li><a href="http://localhost/admin_flow/product/admin_product/fetch1.php">Catalog</a></li>
                <br>
                <li><a href="http://localhost/admin_flow/admin_customer/ad-cust1.php"><i class="fa fa-male"></i></a></li>
                <li><a href="http://localhost/admin_flow/admin_customer/ad-cust1.php">Customers</a></li>
            </div>
        </div>

        <div class="col-md-11">
            <div class="abc">
                <form method="post" action="dbConfigs.php">
                    <div class="main1">
                        ...
                        <table>
                            ...
                            <tr>
                             ...
                             <tr>
                                ...
                                <td style="margin: 40px; padding-left:  50px;"><input type="file" name="file" style="width: 550px"></td> <td><input type="submit" name="submit" value="Upload"></td>
                            ...
                            <tr>
                                ...
                                <td style="margin: 40px; padding-left:  50px;"><input type="text" name="Taxclass" list="tax" style="width: 550px"><datalist id="tax"> <select name="Tax_class">
                                            <option value="None">
                            ...
                            <tr>
                                ...
                                <td style="margin: 40px; padding-left:  50px;"><input type="text" name="Quantity" value="0" style="width: 150px"></td>
                            </tr>
                            <tr>
                                ...
                                <td style="margin: 40px; padding-left:  50px;"><input type="text" name="Status" list="stock" style="width: 150px"><datalist id="stock"> <select name="status">
                            ...
                            <tr>
                                ...
                                <td style="margin: 40px; padding-left:  50px;"><input type="text" name="Categories" list="categories" style="width: 350px"><span><button type="button" class="block" style="background-color: black" "color: white" "margin-left: 50px">New Category</button></span><datalist id="categories"> <select name="Categories">
                                            <option value="Women">
                            ...
                            <tr>
                                ...
                                <td style="margin: 40px; padding-left:  50px;"><input type="text" name="Visibility" list="visibility" style="width: 350px"><datalist id="visibility"> <select name="Visibility">
