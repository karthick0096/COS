    ...
    <div class="row">
        <div class="col-md-1">
            ...
            <div class="main" style="height:100%">
                ...
                <br>
                <li><a href="http://localhost/admin_login/admin_customer/ad-cust.php"><i class="fa fa-male"></i></a></li>
                <li><a href="http://localhost/admin_login/admin_customer/ad-cust.php">Customers</a></li>
            </div>
        </div>
                    ...
                    <div class="page" style="margin-top: 20px;">
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <datalist id="categories"> <select name="Categories"><option disabled="disabled" selected="selected">Select an option.</option>
                                            <option value="Women">
                                            <option value="Default"></option>
                                        </select></datalist>
